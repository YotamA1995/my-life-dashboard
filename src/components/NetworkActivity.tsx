...
export default function NetworkActivity() {
  return (
    <div className="col-span-12 lg:col-span-4 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-xl overflow-hidden flex flex-col">
      {/* Header */}
      ...
      <div className="flex-1">
        {activities.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-4 px-card-padding py-3 border-b border-slate-100 hover:bg-slate-50 transition-colors"
          >
